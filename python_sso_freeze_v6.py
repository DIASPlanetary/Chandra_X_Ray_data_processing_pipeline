...
# 
# As described in *Weigt et al. 2020* The following code is a script that takes Gladstone's stop_hrci and translates it into python. Other contributors to the current and/or previous iterations of this code were: Will Dunn, Brad Snios, Ron Elsner, Caitríona Jackman, Peter Ford, Ralph Kraft, Seán McEntee, and Graziella Branduardi-Raymont.
